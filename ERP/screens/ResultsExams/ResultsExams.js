...
{/* <TeacherMarkingScreen courseid={selectedCourse.course_id} user={user}  /> */}

<CourseStudents  students={selectedCourse?.students}  setShowStudents={setShowStudents} courseid={selectedCourse.course_id} user={user} />
</>) : 
<>
...
{loading ? (<>
  ...
  {user.role=="STUDENT"?
    <StudentGradingScreen course_id={selectedCourse.course_id} setSelected={(value)=>{setSelectedCourse(null)}}/>
    :
    user.role=="TEACHER"
    ?
    null:null}
