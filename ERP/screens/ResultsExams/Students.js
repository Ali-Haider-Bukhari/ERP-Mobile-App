...
export default function CourseStudents({ students , setShowStudents , courseid , user }) {
...
function handleStudentClick(item) {
    
    setShowMarksSection(true)
...
<TeacherMarkingScreen courseid={courseid} student={selectedStudent.student_id} setShowMarksSection={setShowMarksSection}  />
</>
) :(
    <>
...
<TouchableOpacity style={styles.iconButton} onPress={() => setShowStudents(false)}>
...
<FlatList
            ...
            renderItem={({ item }) => (
               ...
               <TouchableOpacity style={styles.container} onPress={() => handleStudentClick(item)}  >
